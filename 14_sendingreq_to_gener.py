def restaurent_customer():
 ...
 #  but agar hum order = yield(line 5) remove kar denge toh jab kuch v order nhi denge tab while loop false we get nothing but in case of order atleast one item while loop true ho jayega aur print karta hie jayee infinite 1st item toh next order par jane ke liye hum isko use kiye hai
